...
export const BRISTOL = [
  { n: 1, label: 'コロコロ', desc: 'かたく小さな塊が、ばらばらに出る' },
  { n: 2, label: 'かたい', desc: '小さな塊が集まった、ごつごつした形' },
  { n: 3, label: 'ややかたい', desc: '表面にひび割れのある、細長い形' },
  { n: 4, label: 'ふつう', desc: 'なめらかでやわらかい、細長い形' },
  { n: 5, label: 'ややゆるい', desc: 'はっきりしたしわのある、やわらかい塊' },
  { n: 6, label: 'どろどろ', desc: '形の境目がくずれた、ふにゃふにゃした状態' },
  { n: 7, label: '水のよう', desc: '固形の部分がない、液体の状態' },
];
