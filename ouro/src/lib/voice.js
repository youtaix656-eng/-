// 音声メモ入力 — 話したことをそのまま会社の材料にする。
//
// 「毎日録音して、話したことをコンテキストとして貯める」が、いちばん安く効く
// 材料の集め方になってきた。手で打ち直す手間がある限り、人は貯めない。
//
// ⚠ プライバシー方針の「明示的な例外」:
//   Ouro の保存は端末内のみ（lib/storage.js はネットワークに触れない）。
//   ただしブラウザの音声認識
...
export const VOICE_PRIVACY_NOTE =
  ...
  + 'お客さんの氏名や連絡先は話さないでください。変換された文字は、他の入力と同じくこの端末の中にだけ保存されます。';
