...
import {
  SELL_MODES, MIN_RUNS, MAX_KITS, normalizeKits, runsOf, kitReady, kitLine, kitsLine,
  kitEffort, exportKit,
} from '../lib/kit.js';
    ...
    >
      ...
      {open && (
        <div style={{ marginTop: 8 }}>
          ...
          <pre className="doc" style={{ whiteSpace: 'pre-wrap', fontSize: 11.5, maxHeight: 260, overflow: 'auto' }}>{md}</pre>
