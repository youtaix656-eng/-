...
export const WORKFLOWS = [
  ...
  {
    // 有料記事＝「無料で読めるレター」＋「お金を払って読む本文」の2部構成。
    // 中身が良くても、手前のレターがイマイチだと手に取ってもらえない——
    // だから**レターを書く手順を独立させる**（本文の担当に片手間で書かせない）。
    // ライターが未雇用なら計画から外れるが、そのことは依頼画面と結果画面が伝える。
    id: 'paid_note',
    name: '有料記事をつくる',
    reading: 'ゆうりょうきじをつくる',
    glyph: '❏',
    desc: '調べる → 読み手と流れを決める → 本文（有料）→ 無料のレター → 言い過ぎと誤りを見る',
    steps: ['researcher', 'analyzer', 'creator', 'writer', 'reviewer'],
    example: '〇〇について、無料のレターつきの有料記事を作って',
  },
  {
    id: 'numbers',
    name: '数字を読む',
  ...
  },
  {
    id: 'market_scan',
    name: '競合と市場を見る',
    reading: 'きょうごうといちばをみる',
    glyph: '◎',
    // **徹底調査（deep_research）とは別物。**
    // あちらは「調べてまとめる」。こちらは**あなたが実際に見た観測を材料に**、
    // 自分との差だけを出す。検索エンジンが繋がっていない時に
    // **もっともらしいURLと値段を作らせないため**、材料は必ず人が入れる。
    desc: '観測を整理する →（自分との差・言い過ぎの確認を同時に）→ 次の一手',
    steps: ['researcher', ['analyzer', 'reviewer'], 'strategist'],
    example: '競合台帳に入れた観測をもとに、私が空けられる所を出して',
  },
  {
    id: 'sort_work',
    name: '仕事の棚卸し',
