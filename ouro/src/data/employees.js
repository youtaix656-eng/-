...
// 同じ名前が回ってしまう（33役職 × 3席 ＝ 99 なので、99名ぶん用意してある）。
// **役職を足したら、ここも 3名ずつ足すこと**（テストが機械チェックする）。
export const EXTRA_NAMES = [
  ...
  // 役職を3つ足したので9名ぶん追加（33役職 × 3席 ＝ 99）
  { name: 'チヒロ', reading: 'ちひろ' },
  { name: 'ツバキ', reading: 'つばき' },
  { name: 'テルミ', reading: 'てるみ' },
  { name: 'トワ', reading: 'とわ' },
  { name: 'ナルミ', reading: 'なるみ' },
  { name: 'ニイナ', reading: 'にいな' },
  { name: 'ヌマタ', reading: 'ぬまた' },
  { name: 'ネイロ', reading: 'ねいろ' },
  { name: 'ノノカ', reading: 'ののか' },
];
