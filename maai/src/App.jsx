...
const NAV = [
  ...
  { id: 'approach', label: '近づく', icon: GLYPHS.circlePlus },
    ...
    <div className="app">
      ...
      {view === 'approach' && (
        <Approach
          ...
          tried={store.tried}
          onToggleTried={store.toggleTried}
          onGo={go}
        />
      )}
      ...
      {view === 'consent' && <Consent focus={focus} onFocusDone={clearFocus} />}
      {view === 'replies' && <Replies focus={focus} onFocusDone={clearFocus} />}
      {view === 'habits' && <Habits focus={focus} onFocusDone={clearFocus} />}
      {view === 'myths' && <Myths focus={focus} onFocusDone={clearFocus} onGo={go} />}
      ...
      {view === 'settings' && (
        <Settings
          ...
          triedCount={Object.keys(store.tried).length}
