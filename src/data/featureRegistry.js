...
const featureRegistry = [
  ...
  { id: 'keizetsutextbook', title: '経絡経穴 教科書目次（ページ順）', icon: '📖', category: '学習・演習', view: 'keizetsutextbook', desc: '教科書の章立てをページ範囲ごと（総論・督脈〜肝経の各経脈・奇経八脈・奇穴・現代医学的研究・参考資料）に自分の言葉で要約して収録（keizetsuTextbookMap.js。原文はコピーしない方針）。収録済み過去問（第25〜34回、keizetsuQuestions.jsのgenreタグ）から各範囲の出題数を実際に集計し🔴🟠🟡⚪の4段階で表示、どこが頻出かを一目で確認できる。教科書原文をそのまま読みたい場合は端末内保存の教科書ライブラリへ誘導する。索引・目次画面、フラッシュカード画面から遷移。', tags: ['経絡経穴', '教科書', 'ページ', '出題頻度', '色分け'] },
