...
const featureRegistry = [
  ...
  { id: 'quiz', title: '一問一答', icon: '✏️', category: '学習・演習', view: 'quiz', desc: '科目別に問題演習。○×・四択に対応。ミニタイムアタックモード（10/15/20秒の制限時間つき軽量版）で、日常の演習でも本番のペース感覚を鍛えられる。', tags: ['一問一答', 'タイムアタック'] },
  ...
  { id: 'exam', title: '模擬試験', icon: '📝', category: '学習・演習', view: 'exam', desc: '午前/午後(本番同形式)・得意/苦手(自動提案)・選択式の5モード。午前/午後は解答中に「今ごろ何問目のペースか」を表示し遅れを検知、終了後は時間を使いすぎた問題トップ5と、前半/後半の正答率比較（集中力の持続チェック）を表示する。', tags: ['模試', '本番形式', 'ペース管理', '集中力'] },
  ...
  { id: 'coverage', title: '網羅マップ', icon: '🗺️', category: '復習・弱点対策', view: 'coverage', desc: '出題基準×収録数を色で俯瞰。手薄・未収録の科目が一目で分かる。総合問題（連問）専用のカバー状況（午前/午後の目標出題数に対する収録数・事例数）も表示。', tags: ['網羅マップ', '総合問題'] },
