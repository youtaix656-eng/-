...
const featureRegistry = [
  ...
  { id: 'faq', title: '鍼灸国試アプリ Q&A', icon: '❓', category: '設定・その他', view: 'faq', desc: '使い方・学習の悩み・不具合など、よくある質問42件をキーワード1語でも文章まるごとでも検索できる（faq.js＋faqSearch.js、2文字N-gramの一致率で緩く拾う簡易全文検索）。ホームの「全機能一覧」の下から遷移。', tags: ['Q&A', 'よくある質問', 'ヘルプ', 'サポート', '検索'] },
