...
const featureRegistry = [
  ...
  { id: 'calendar', title: 'カレンダー', icon: '🗓️', category: '記録・管理', view: 'calendar', desc: '勉強や試験の予定を書き込み。試験までのカウントダウンも。下部ナビの2番目。月表示にロードマップのフェーズを重ね、「全期間のロードマップを見る」で合格ロードマップへ。', tags: ['カレンダー', 'ロードマップ'] },
  ...
  { id: 'roadmap', title: '合格するためのロードマップ', icon: '🗺️', category: '記録・管理', view: 'roadmap', desc: '本番までの計画・やること/NG・新規→△✕の切替時期・音声学習の使い方まで。下部ナビの直上に常設バーがあり、ロードマップ画面以外のどこからでも開ける。「カレンダーで予定に落とし込む」でカレンダー画面へ。', tags: ['ロードマップ', '計画', '常設バー'] },
