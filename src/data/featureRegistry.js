...
const featureRegistry = [
  // ---- 学習・演習 ----
  { id: 'session', title: '学習（10・60・300・900）', icon: '📚', category: '学習・演習', view: 'session', desc: '60問で区切り・300問で今日の目標・900問で1周。1問ごと自動保存で、いつでも続きから。完了画面で「明日の最初の1タスク」も決められます。完了時には所要時間を記録し、同じ目標数での前回と比べた時短率（周回速度ログ）も表示。', tags: ['学習セッション', '習慣化', '明日のタスク', '周回速度ログ'] },
